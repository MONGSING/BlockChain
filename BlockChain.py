...
BC = Blockchain()
BC.mine_block("This is the second block")
BC.mine_block("This is the third block")
BC.mine_block("This is the fourth block")
BC.mine_block("This is the fifth block")
print(BC.chain)

print("-------------------Traversing the blocks in the blockchain---------------------------")
for block in BC.chain:
    print(block)

print("----------------- Printing the validity of the chain --------------------------------")
print(BC.is_chain_valid())


print("----------------------- Tampering the chain  ----------------------------------------")
BC.chain[0]['timestamp'] = "0000000000"
